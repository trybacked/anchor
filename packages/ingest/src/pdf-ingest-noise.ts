/* eslint-disable no-console -- this module intentionally patches console.log during PDF ingest. */
...
export function beginPdfIngestNoiseFilter(): void {
  if (filterDepth === 0) {
    ...
    process.stderr.write = ((chunk, encoding, callback) => {
      if (
        isPdfIngestNoise(chunkToText(chunk, typeof encoding === "string" ? encoding : undefined))
      ) {
