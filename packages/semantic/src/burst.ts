...
import { BURST_RETRY_DELAYS_MS, MAX_BURST_ATTEMPTS } from "./constants.js";
...
async function runAttempt<TSchema extends z.ZodTypeAny>(request: BurstRequest<TSchema>, onWaiting?: (message: string) => void): Promise<BurstResult<z.infer<TSchema>>> {
