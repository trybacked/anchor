...
export function lowConfidenceDoubts(
  assembly: AssemblyResult,
  questionTargets: Set<string>,
): Doubt[] {
  const doubts: Doubt[] = [];
...
export function documentEntityIds(
...
export function mergeClassificationOutputs(
...
export function buildReviewQuestions(
  ...
  const documentTypeQuestions =
    documentCatalog !== undefined
      ? selectDocumentTypeReviewQuestions(documentCatalog, assembly.entities, routing.allTables)
      : [];
