...
const AMOUNT_CUE_PATTERN =
  /importo|amount|costo|prezzo|contratt|liquidaz|impegno|spesa|pagament|aggiudic|€|\$/i;
...
export function ensureCurrencyFactTypes(
  ...
  const withoutDefault = vocabulary.factTypes.map((factType) =>
    factType.isDefault && factType.quantity === "currency"
