...
function needsReviewQuestion(confidence: number): boolean {
...
export function selectReviewQuestions(
    ...
    const candidates: QuestionCandidate[] = [
        ...entities
            .filter((entity) => needsReviewQuestion(entity.confidence))
        ...
        ...relations
            .filter((relation) => needsReviewQuestion(relation.confidence))
        ...
        ...rules
            .filter((rule) => needsReviewQuestion(rule.confidence))
