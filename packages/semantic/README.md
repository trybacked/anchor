...
- `selectReviewQuestions` — one question per entity/relation/rule below **`LOW_CONFIDENCE_THRESHOLD`** (`0.7`), sorted by **descending risk** (impact × uncertainty), with no question cap
