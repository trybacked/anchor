...
export const PROCUREMENT_VOCABULARY: DomainVocabulary = DomainVocabularySchema.parse({
  ...
  entitySectors: [
    ...
    {
      id: "servizi_tecnici",
      label: "Servizi tecnici",
      description: "Studi tecnici e progettazione",
    },
  ...
  entityRoles: [
    {
      id: "aggiudicataria",
      label: "Aggiudicataria",
      description: "Impresa che si aggiudica l'appalto",
    },
    {
      id: "mandante_rti",
      label: "Mandante RTI",
      description: "Impresa mandante di un raggruppamento",
    },
