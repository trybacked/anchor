...
import {
  ...
  isOcrNoiseLine,
  normalizeLine,
} from "../../src/extract-header-fields.js";
...
describe("extractVocabularyFields", () => {
  it("reads identifier values using vocabulary cues", () => {
    const procurement = extractVocabularyFields(
      ["Award notice CIG 1234567890"],
      PROCUREMENT_VOCABULARY,
    );
    const english = extractVocabularyFields(
      ["Invoice against PO 4451"],
