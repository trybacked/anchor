...
import { DEFAULT_SOURCES_DIR, WorkspaceConfigSchema, workspacePaths } from "./workspace.js";
...
export function patchWorkspaceConfig(root: string, patch: Partial<WorkspaceConfig>): string {
    ...
    try {
        ...
        existing = { sourcesDir: DEFAULT_SOURCES_DIR, documentTypeHints: [] };
    }
...
export function readRunArtifact<TSchema extends z.ZodTypeAny>(root: string, runId: string, artifact: RunArtifactName, schema: TSchema): z.infer<TSchema> {
