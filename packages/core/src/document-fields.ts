...
export const DOCUMENT_INFRASTRUCTURE_COLUMNS = [
  "document_id",
  "source_file",
  "page_count",
] as const;
 ...
 *
 */
export function isDocumentInfrastructureColumn(
  column: string,
): column is DocumentInfrastructureColumn {
 ...
 *
 */
export function hasEnrichmentFieldValues(
  fields: Record<string, string | null | undefined>,
): boolean {
  return (
    fields[DOCUMENT_ENRICHMENT_FIELD_TOPICS] !== undefined ||
